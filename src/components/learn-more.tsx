...
const LearnMore = () => {
  return (
    <div className="px-5 md:px-[4rem] mt-[4rem] mb-[2rem]">
      <h2 className=" text-secondary_color font-medium text-xl font-font">
        Our Product
      </h2>
        ...
        <section className=" grid gap-4 text-left">
          ...
          <main className=" flex md:hidden justify-center gap-3 text-center">
            <div>
              ...
              <h1 className=" text-text_color text-xs pt-3">
                Years of Experience
              </h1>
            </div>
            <div>
              <h2 className=" font-medium text-xl text-black ">200+</h2>
              <h1 className=" text-text_color text-xs pt-3">Happy Customers</h1>
            </div>
            <div>
              <h2 className=" font-medium text-xl text-black">100+</h2>
              <h1 className=" text-text_color text-xs pt-3">Products</h1>
            </div>
          </main>
